...
#		"com.collaboraoffice.Office" # Collabora office (currently plugins not working, should work on x86_64 and aarch64 platform - horrible shit show, do not use for now 2026-06-03
